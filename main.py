...
with world.World('SF', save_location='/home/dallen/snap/minecraft/common/.minecraft/saves') as wrld:
    print('World loaded!')
    cv = canvas.Canvas(wrld)
    cv.brush(world.BlockState('minecraft:gold_block', {})).square((30, 3, 30), 100)
    print("=====")
